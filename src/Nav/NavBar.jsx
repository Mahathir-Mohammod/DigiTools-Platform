  ...
  return (
    <nav className="sticky top-0 z-[1000] w-full border-b border-[#f0f0f0] bg-white px-5 py-0 shadow-sm md:px-10">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between">
        ...
        {/* Logo */}
        <a href="/" className="text-xl font-bold tracking-tighter text-[#7c3aed] select-none">
          DigiTools
        </a>
        ...
        <div className="hidden items-center gap-5 md:flex">
          <button className="flex items-center gap-[6px] p-1 text-[0.9rem] font-medium text-[#374151] transition-colors hover:text-[#7c3aed]" aria-label="Cart">
          ...
          <button className="p-1 text-[0.9rem] font-medium text-[#374151] transition-colors hover:text-[#7c3aed]">
            Login
          </button>
          <button className="whitespace-nowrap rounded-full bg-[#7c3aed] px-[22px] py-[10px] text-[0.88rem] font-semibold text-white shadow-[0_2px_10px_rgba(124,58,237,0.35)] transition-all hover:-translate-y-[1px] hover:bg-[#6d28d9] hover:shadow-[0_4px_16px_rgba(124,58,237,0.45)] active:translate-y-0">
            Get Started
          </button>
        </div>
      ...
      <div className={`${menuOpen ? "flex" : "hidden"} absolute left-0 right-0 top-16 flex-col gap-1 border-t border-[#f0f0f0] bg-white p-4 pb-6 shadow-lg md:hidden`}>
        {NAV_LINKS.map((link) => (
          <a
            ...
            className="border-b border-[#f5f5f5] py-2.5 text-[0.95rem] font-medium text-[#374151] transition-colors hover:text-[#7c3aed]"
          >
            {link}
          </a>
        ))}
